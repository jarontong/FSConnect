package com.jaron.fsconnectparent.tlslibrary.service;
...
public class Constants {
    ...
    // 配置信息
    public final static String TLS_SETTING = "jaron.fsconnect.tls.ui.TLS_SETTING"; // 配置名
    public final static String SETTING_LOGIN_WAY = "jaron.fsconnect.tls.ui.SETTING_LOGIN_WAY"; // Key

    // 定义业务数据键值
    public final static String COUNTRY_CODE = "jaron.fsconnect.tls.ui.COUNTRY_CODE";
    public final static String PHONE_NUMBER = "jaron.fsconnect.tls.ui.PHONE_NUMBER";
    public final static String USERNAME = "jaron.fsconnect.tls.ui.USERNAME";
    public final static String PASSWORD = "jaron.fsconnect.tls.ui.PASSWORD";

    // 登录方式
    public final static String EXTRA_LOGIN_WAY = "com.jaron.fsconnect.tls.LOGIN_WAY";
    ...
    public final static String EXTRA_SMS_REG = "com.jaron.fsconnect.tls.SMS_REG";
    ...
    // 短信登录的相关常量
    public final static String EXTRA_MOBILE = "com.jaron.fsconnect.tls.MOBILE";
    public final static String EXTRA_SMS_LOGIN = "com.jaron.fsconnect.tls.SMS_LOGIN";
    ...
    // QQ相关的常量
    public final static String EXTRA_QQ_LOGIN = "com.jaron.fsconnect.tls.QQ_LOGIN";
    public final static int QQ_LOGIN_FAIL = 0;
    public final static int QQ_LOGIN_SUCCESS = 1;
    public final static int QQ_LOGIN_NON = 2;
    public final static String EXTRA_QQ_OPENID = "com.jaron.fsconnect.tls.QQ_OPENID";
    public final static String EXTRA_QQ_ACCESS_TOKEN = "com.jaron.fsconnect.tls.QQ_ACCESS_TOKEN";

    // 微信相关的常量
    public final static String EXTRA_WX_LOGIN = "com.jaron.fsconnect.tls.WX_LOGIN";
    public final static int WX_LOGIN_FAIL = 0;
    public final static int WX_LOGIN_SUCCESS = 1;
    public final static int WX_LOGIN_NON = 2;
    public final static String EXTRA_WX_OPENID = "com.jaron.fsconnect.tls.WX_OPENID";
    public final static String EXTRA_WX_ACCESS_TOKEN = "com.jaron.fsconnect.tls.WX_ACCESS_TOKEN";

    // 账号密码注册相关常量
    public final static int USRPWD_REG_REQUEST_CODE = 1;
    public final static String EXTRA_USRPWD_REG = "com.jaron.fsconnect.tls.SMS_REG";
    ...
    // 账号密码登录的相关常量
    public final static String EXTRA_USRPWD_LOGIN = "com.jaron.fsconnect.tls.USRPWD_LOGIN";
    ...
    // 手机密码注册的相关常量
    public final static String EXTRA_PHONEPWD_REG_RST = "com.jaron.fsconnect.tls.PHONEPWD_REG_RST";
    ...
    // 手机密码登录的相关常量
    public final static String EXTRA_PHONEPWD_LOGIN = "com.jaron.fsconnect.tls.EXTRA_PHONEPWD_LOGIN";
    ...
    public final static String EXTRA_THIRDAPP_PACKAGE_NAME_SUCC = "com.jaron.fsconnect.tls.THIRDAPP_PACKAGE_NAME_SUCC";
//    public final static String EXTRA_THIRDAPP_CLASS_NAME_SUCC = "com.jaron.fsconnect.tls.THIRDAPP_CLASS_NAME_SUCC";
    public final static String EXTRA_THIRDAPP_CLASS_NAME_SUCC = null;
    public final static String EXTRA_THIRDAPP_PACKAGE_NAME_FAIL = "com.jaron.fsconnect.tls.THIRDAPP_PACKAGE_NAME_FAIL";
    public final static String EXTRA_THIRDAPP_CLASS_NAME_FAIL = "com.jaron.fsconnect.tls.THIRDAPP_CLASS_NAME_FAIL";

    public final static String EXTRA_IMG_CHECKCODE = "com.jaron.fsconnect.tls.EXTRA_IMG_CHECKCODE";
