...
import com.jaron.fsconnectparent.model.GroupMemberProfile;
import com.jaron.fsconnectparent.model.UserInfo;
import com.jaron.fsconnectparent.ui.LineControllerView;
import com.jaron.fsconnectparent.ui.ListPickerDialog;
...
public class GroupMemberProfileActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CircleImageView avater=(CircleImageView)findViewById(R.id.avater) ;
        ImageLoader.loadImage(Glide.with(this),avater, profile.getAvatarUrl(), R.drawable.head_other);
