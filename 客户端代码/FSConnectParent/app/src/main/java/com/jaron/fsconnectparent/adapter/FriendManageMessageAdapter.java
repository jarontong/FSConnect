...
import com.jaron.fsconnectparent.model.FriendFuture;
            ...
            case TIM_FUTURE_FRIEND_PENDENCY_IN_TYPE:
                ...
                viewHolder.status.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        FriendshipManagerPresenter.acceptFriendRequest(data.getIdentify().substring(data.getIdentify().length()-11), new TIMValueCallBack<TIMFriendResult>() {
                            @Override
