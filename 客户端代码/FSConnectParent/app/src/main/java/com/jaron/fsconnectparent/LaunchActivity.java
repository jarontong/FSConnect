...
import com.jaron.fsconnectparent.account.activity.BindStudentActivity;
...
import com.jaron.fsconnectparent.presentation.business.InitBusiness;
...
import com.jaron.fsconnectparent.presentation.presenter.SplashPresenter;
...
//初始化程序后台后消息推送
        ...
        if(AccountHelper.getUser().getStudent()==null){
            BindStudentActivity.show(this,"LaunchActivity");
            finish();
        }
        else {
