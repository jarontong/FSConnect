...
import com.jaron.fsconnectparent.activities.GroupManageMessageActivity;
...
public class GroupManageConversation extends Conversation {
    ...
    public String getAvatar() {
        return String.valueOf(R.drawable.ic_news);
    }
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return FSConnectApplication.getContext().getResources().getString(R.string.summary_me)+
                            FSConnectApplication.getContext().getResources().getString(R.string.summary_group_invite)+
                            to+
                            FSConnectApplication.getContext().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                FSConnectApplication.getContext().getResources().getString(R.string.summary_group_invite)+
                                FSConnectApplication.getContext().getResources().getString(R.string.summary_me)+
                                FSConnectApplication.getContext().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                FSConnectApplication.getContext().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return FSConnectApplication.getContext().getResources().getString(R.string.summary_me)+
                            FSConnectApplication.getContext().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+FSConnectApplication.getContext().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return FSConnectApplication.getContext().getString(R.string.conversation_system_group);
    }
