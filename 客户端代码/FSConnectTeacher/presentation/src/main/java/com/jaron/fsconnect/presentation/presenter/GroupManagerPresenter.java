package com.jaron.fsconnect.presentation.presenter;
...
import com.jaron.fsconnect.presentation.viewfeatures.GroupInfoView;
import com.jaron.fsconnect.presentation.viewfeatures.GroupManageMessageView;
import com.jaron.fsconnect.presentation.viewfeatures.GroupManageView;
    ...
    public void searchGroupByName(String key){
        ...
        TIMGroupManager.getInstance().searchGroup(key, flag, null, 0, 30, new TIMValueCallBack<TIMGroupSearchSucc>() {
            ...
            public void onSuccess(TIMGroupSearchSucc timGroupSearchSucc) {
                ...
                Log.d(TAG,"pass2");
                Log.d("timGroupSearchSucc",String.valueOf(timGroupSearchSucc.getInfoList().size()));
