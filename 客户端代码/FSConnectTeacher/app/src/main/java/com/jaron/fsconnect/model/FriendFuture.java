...
public class FriendFuture {
    ...
    public String getName(){
        return futureItem.getProfile().getNickName().equals("") ? futureItem.getIdentifier().substring(futureItem.getIdentifier().length()-11) : futureItem.getProfile().getNickName();
    }
