...
import com.jaron.fsconnect.adapter.HomeworkAdapter;
import com.jaron.fsconnect.api.FSConnectApi;
import com.jaron.fsconnect.app.AppOperator;
import com.jaron.fsconnect.base.BaseBackActivity;
...
public class HomeworkActivity extends BaseBackActivity implements
    ...
    private void getData(final boolean clearData ,int offset) {
        FSConnectApi.getHomeworkByTeacher(AccountHelper.getUserId(),offset, new TextHttpResponseHandler() {
            @Override
