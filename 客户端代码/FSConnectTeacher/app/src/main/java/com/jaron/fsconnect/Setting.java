...
public final class Setting {
    ...
    private static final String KEY_VERSION_CODE = "versionCode";//整数值，代表应用程序代码的相对版本
    public static final String KEY_APP_UNIQUE_ID = "appUniqueID";//app唯一标识
    private static final String KEY_SYSTEM_CONFIG_TIMESTAMP = "systemConfigTimeStamp";//系统配置时间戳
    private static final String KEY_LOCATION_INFO = "locationInfo";//定位信息
    private static final String KEY_LOCATION_PERMISSION = "locationPermission";//位置权限
    private static final String KEY_LOCATION_APP_CODE = "locationAppCode";//定位应用程序代码
    private static final String KEY_SOFT_KEYBOARD_HEIGHT = "softKeyboardHeight";//软键盘高度
    ...
    public static String getServerUrl(Context context) {
        ...
        if (TextUtils.isEmpty(url)) {
            String[] urls = {"http://172.20.10.2:8080/server-ssm/","https://172.20.10.2:8080/server-ssm/"};//改url
            if (urls.length > 0) {
                url = urls[0];
            } else {
                url = "http://172.20.10.2:8080/server-ssm/";//改
            }
